...
@section('container')
    ...
    <div
        class="p-4 my-20 mb-4 text-red-800 border border-red-500 rounded-lg glass dark:bg-gray-800 dark:text-red-400 dark:border-red-800">
        <div class="flex items-center ">
            ...
            <h3 class="text-lg font-medium">Silahkan isi presensi hari ini ya</h3>
        </div>
        <div class="mt-2 mb-4 text-sm">
            Jangan Lupa Absen ya!
            <br>
            <a href="/dashboard/absensi/create" class="text-blue-500">
                Berhalangan Hari Ini?</a>
        </div>
