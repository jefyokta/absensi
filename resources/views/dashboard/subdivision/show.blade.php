                ...
                <div class="card-body">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody class="glass rounded-es-lg">
                            ...
                            <td class="px-6 py-4 flex items-center"><a href="/dashboard/employees/{{ $user->id }}/edit"
                                    class="badge bg-dark border-0"><svg class="w-6 h-6 text-green-800 dark:text-white"
