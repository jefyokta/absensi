...
@section('container')
    <div class="row mb-3">
        <div class="col-6">
            <div class="card">
                <h5 class="font-semibold m-5 text-xl"> Edit Sub Divisi</h5>
                <div class="card-body mx-2">
                    <form action="/dashboard/sub_divisions" method="POST" class="glass p-5 max-w-content">
                        @method('put')
                        @csrf
                        <div class="mb-5 ">
                            <input type="hidden" value="{{ $sub_division->id }}">
                            ...
                            <input type="name"@required(true) class="form-control p-2 w-8/12" id="name"
                                name="name" placeholder="CEO" autofocus required value="{{ $sub_division->name }}">
                        </div>
                        <div class="mb-5">
                            <select id="countries"
