<div>
    <div class="relative z-0 w-full mb-5 group">
        <input type="{{ $showpassword ? 'text' : 'password' }}" name="password" id="floating_password"
    ...
    <div class="relative z-0 w-full mb-5 group">
        <input type="{{ $showConfirmPassword ? 'text' : 'password' }}" wire:model.live="confirmpassword"
            name="password_confirmation" id="floating_repeat_password"
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
            placeholder=" " required />
        <label for="floating_repeat_password"
            ...
            password</label>
        <button wire:click="setconfirmpassword" wire:model.live="confirmpassword" class="absolute right-0 top-2"
            type="button">
