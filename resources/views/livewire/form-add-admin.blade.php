        ...
        <div class="col-6">
            <div class="card">
                ...
                <div class="card-body mx-2">
                    ...
                    <form class="max-w-md mx-auto glass p-5 rounded-md" action="/super/admin" method="POST">
                        @csrf
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="{{ $showpassword ? 'text' : 'password' }}" name="password"
                                id="floating_password" wire:model.live="password"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            ...
                            <button wire:click="setpassword" class="absolute right-0 top-2" type="button">
                                @if (!$showpassword)
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="{{ $showConfirmPassword ? 'text' : 'password' }}"
                                wire:model.live="confirmpassword" name="password_confirmation"
                            ...
                            <label for="floating_repeat_password"
                                ...
                                password</label>
                            <button wire:click="setconfirmpassword" wire:model.live="confirmpassword"
                                class="absolute right-0 top-2" type="button">
                            ...
                            @if ($confirmerror)
                                <span class="text-xs text-red-500">password tidak cocok</span>
                            @endif
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <textarea type="text" name="address" id="floating_last_name"
                                ...
                                placeholder=" " required value="{{ old('address') }}"></textarea>
                        ...
                        @else
                            <div class="relative z-0 w-full mb-5 group">
                                <select type="text" name="divisions_id" id="floating_company"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" ">
                                    <option value="">Tidak memiliki Divisi</option>
                        ...
                        @endif
                        <button type="submit" {{ $confirmerror ? 'disabled' : '' }}
